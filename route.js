...
var router = new Navigo(null, true, '#!'); //I WOULD HESITATE TO TOUCH THESE AS IT CAN EASILY F EVERYTHING UP AND IF WE CAN GET IMPLEMENTATION WITHOUT HAVING
//THAVING TO MESS WITH PATHS THEN IT WOULD BE ALOT SMOOTHER
