...
function User() {
    ...
    this.create = function(user) { //CREATES A NEW USER WHICH REQURES A USERNAME/LOGIN/PASSWORD AND NOTHING ELSE(EVERYTHING ELSE IS OPTIONAL)
        //YOU CAN CTRL F TO FIND THE "user" VAR AND THAT WILL SHOW HOW THE USER IS CREATED
