...
function Login() { // THIS IS THE FUNCTION THAT RUNS WHEN LOGIN IS PRESSED, CAN HOOK THIS UP TO A BUTTON THAT TAKES YOU TO CHAT FUNCTIONALTY AND 
    //THEN NAVIGATES YoU TO THE "/dashboard" WHICH IS IN THE HTML AND SEEMS TO BE WHAT PAGE IS LOADED ONCE SOMEONE SUCSESSFULLY LOGS IN
...
Login.prototype.setListeners = function(){ //THE ACTUAL FUNCTION THAT PULLS FROM THE TEXT BOXES TO CREAT USER AND PASSWORD
    var self = this,
